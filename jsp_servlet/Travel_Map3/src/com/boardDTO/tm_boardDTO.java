...
public class tm_boardDTO {
	...
	public tm_boardDTO(int tb_seq, String tb_title, String tb_content, String tb_file, int tb_cnt, String tb_date,
			int tb_likes, int tb_total, String tb_open, String mb_id, int travel_seq) {
		this.tb_seq = tb_seq;
	...
	public tm_boardDTO(int tb_seq, String tb_title, String tb_content, String tb_file, int tb_cnt, int tb_likes,
